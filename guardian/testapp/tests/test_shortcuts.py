...
class GetPermsVsGetUserPermsTest(TestCase):
    ...
    def test_return_type_consistency(self):
        ...
        self.assertIsInstance(
            user_perms, QuerySet, "get_user_perms should return a QuerySet"
        )
        self.assertIsInstance(
            group_perms, QuerySet, "get_group_perms should return a QuerySet"
        )
    ...
    def test_inactive_user_behavior(self):
        ...
        print(
            f"Inactive user - get_perms: {all_perms}, get_user_perms: {user_perms}, get_group_perms: {group_perms}"
        )

        # all functions should return empty for inactive users
        self.assertEqual(
            all_perms, [], "get_perms should return empty list for inactive user"
        )
        self.assertEqual(
            user_perms, [], "get_user_perms should return empty list for inactive user"
        )
        self.assertEqual(
            group_perms,
            [],
...
class NonStandardPKTests(TestCase):
    ...
    def test_text_pk_get_objects_for_user_single_permission(self):
        ...
        obj1 = TextPKModel.objects.create(
            text_pk="00:00:00:00:00:01"
        )  # Simulates macaddr
        ...
        self.assertTrue(isinstance(objects, QuerySet))
        self.assertEqual(
            set(objects.values_list("text_pk", flat=True)), {obj1.text_pk, obj2.text_pk}
        )
    ...
    def test_text_pk_get_objects_for_user_multiple_permissions(self):
        ...
        objects = get_objects_for_user(
            self.user, ["testapp.add_textpkmodel", "testapp.change_textpkmodel"]
        )

        self.assertEqual(len(objects), 1)
        self.assertEqual(
            list(objects.values_list("text_pk", flat=True)), [obj1.text_pk]
        )
    ...
    def test_text_pk_get_objects_for_user_with_groups(self):
        ...
        objects = get_objects_for_user(
            self.user, "testapp.add_textpkmodel", use_groups=True
        )
    ...
    def test_text_pk_get_objects_for_user_without_groups(self):
        ...
        objects = get_objects_for_user(
            self.user, "testapp.add_textpkmodel", use_groups=False
        )
    ...
    def test_text_pk_get_objects_for_user_accept_global_perms_false(self):
        ...
        objects = get_objects_for_user(
            self.user, "testapp.add_textpkmodel", accept_global_perms=False
        )
    ...
    def test_text_pk_get_objects_for_group_multiple_permissions(self):
        ...
        # Test with multiple permissions (requires ALL)
        objects = get_objects_for_group(
            self.group, ["testapp.add_textpkmodel", "testapp.change_textpkmodel"]
        )
    ...
    def test_text_pk_get_objects_for_group_accept_global_perms_false(self):
        ...
        # Test with accept_global_perms=False
        objects = get_objects_for_group(
            self.group, "testapp.add_textpkmodel", accept_global_perms=False
        )
    ...
    def test_text_pk_mixed_user_and_group_permissions(self):
        ...
        obj2 = TextPKModel.objects.create(text_pk="192.168.1.1")
        obj3 = TextPKModel.objects.create(text_pk="some-text-id")
        obj4 = TextPKModel.objects.create(text_pk="another-id")
    ...
    def test_text_pk_queryset_parameter(self):
        ...
        objects = get_objects_for_user(
            self.user, "testapp.add_textpkmodel", klass=queryset
        )
    ...
    def test_text_pk_special_characters(self):
        ...
        ipv6_obj = TextPKModel.objects.create(
            text_pk="2001:0db8:85a3:0000:0000:8a2e:0370:7334"
        )
        ...
        returned_pks = set(objects.values_list("text_pk", flat=True))
        self.assertEqual(
            returned_pks, {mac_obj.text_pk, ipv4_obj.text_pk, ipv6_obj.text_pk}
        )
    ...
    def test_comparison_with_standard_pk_types(self):
        ...
        uuid_obj2 = UUIDPKModel.objects.create()
        ...
        text_obj2 = TextPKModel.objects.create(text_pk="text-id-2")
