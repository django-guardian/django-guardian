...
class ObjectPermissionCheckerTest(ObjectPermissionTestCase):
    ...
    def test_get_perms(self):
        ...
        GroupObjectPermission.objects.assign('change_group', self.group, self.group)
        UserObjectPermission.objects.assign('delete_group', self.user, self.group)
        
        self.assertEqual(['change_group', 'delete_group'], sorted(check.get_perms(self.group)))
