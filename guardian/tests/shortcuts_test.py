...
from permission_backend_nonrel.models import GroupPermissionList
...
class AssignTest(ObjectPermissionTestCase):
	...
	def test_user_assign(self):
		...
		assign("delete_contenttype", self.user, self.ctype)
		...
		self.assertFalse(self.user.has_perm("delete_group", self.group))
